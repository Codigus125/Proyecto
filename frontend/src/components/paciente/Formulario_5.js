...
///////////////////////////////////////////////////////////////////////////////////////////////////
	...
	const UPDATE_PACIENTE_F5 = gql`
	mutation Mutation($rut: String!, $nuevosDatos: Formulario5!) {
		updatePaciente_F5(rut: $rut, NuevosDatos: $nuevosDatos) {
		  excepcion {
			situ_crisis_persona
			excepcion
			excepcion_cual
	...
	const [handleUpdate] = useMutation(UPDATE_PACIENTE_F5,{variables:{rut:Rut ,nuevosDatos:NuevosDatos }});

    const handleUpdatePacienteF5 = async (e) => {
        e.preventDefault();
        try {
			...
			<div className="container pt-3 pb-2 mt-2 text-bg border border-2 border-dark rounded col-12">
				...
				<form ref={formRef} onSubmit={handleSubmit}>
					...
					<div className="btn-group-wide d-grip mb-2 text-center">
						...
						onClick={handleUpdatePacienteF5}>Guardar</button>
					</div>
				</form>
			</div>
			</div>
