	...
	render(){ 
		return(
			<div>
				...
				<div className='d-flex h3 justify-content-center 'style={{color:'#FB4D72'}} >Avisos / Noticias Persona con Discapacidad</div>
				...
				<div className='row m-0 mt-0 border shadow flex' style={{display: "flex", justifyContent: "space-between", padding: "0px", marginBottom: "0", background:'#f5f5f5'}}>
					<BotonCuadro imagen={registroIcon} titulo="Modificar Mis Datos" direccion={"ModUsuarioPaciente/"} descripcion=""/>
					<BotonCuadro imagen={VoidIcon}></BotonCuadro>
					<BotonCuadro imagen={prestamoIcon} titulo="Formulario de solicitud" direccion={"FormularioSolicitudPaciente/"} descripcion=""/>
					<BotonCuadro imagen={VinculoIcon} titulo="Vínculo Generado" direccion={"VinculacionPaciente/"} descripcion=""/>
				</div>
